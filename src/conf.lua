local iconpath = "assets/img/player/hero.png"
...
function love.conf(t)
  ...
  t.window.title = "Choreboyz"         -- The window title (string)
  ...
  t.window.height = 1088               -- The window height (number)
  t.window.borderless = false         -- Remove all border visuals from the window (boolean)
  t.window.resizable = true          -- Let the window be user-resizable (boolean)
  t.window.minwidth = 1920               -- Minimum window width if the window is resizable (number)
  t.window.minheight = 1088              -- Minimum window height if the window is resizable (number)
